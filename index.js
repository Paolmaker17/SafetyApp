  ...
  usersTable.append(
    ...response.map(user =>
      elClass("tr", "border-b border-(--border) transition",
        elClass("td", "p-3 flex items-center gap-3 text-[var(--text-light)] font-semibold w-full rounded-xl border border-[var(--border)] outline-none transition bg-[var(--card)]",
